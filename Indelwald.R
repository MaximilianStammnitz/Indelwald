...
#### Notes:
#### - Reference context bases up to +- 500 bp of all indel sites will be 
#### extracted, thus please remove any indels falling right into the chromosome 
#### boundaries +- 500 bp. 
#### - For the same processing reasons, please also remove all indels >80 bp.
spectrum.out <- indel.spectrum(x = input.vcf)

### 2.d Plot the indel spectrum
pdf("my_first_indel_spectrum.pdf", height = 12, width = 24)
